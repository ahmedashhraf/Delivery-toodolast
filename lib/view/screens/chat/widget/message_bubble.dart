...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print('====Company Logo====> ${Get.find<ChatController>().userTypeIndex} ${Get.find<SplashController>().configModel!.companyLogo}');
    ...
    bool _isReply = message.sentByCustomer == 1 || message.sentBySeller == 1 || message.sentByAdmin == 1;
    ...
    return (_isReply) ? Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text(name!, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge,
    ...
    : Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
        ...
        Text(Get.find<ProfileController>().profileModel!.fName!+" "+Get.find<ProfileController>().profileModel!.lName!, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge)),
         SizedBox(height: Dimensions.paddingSizeSmall),
