          ...
          Padding(padding:  EdgeInsets.symmetric(vertical: Dimensions.paddingSizeSmall),
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              isAmount? Text(Get.find<SplashController>().myCurrency!.symbol!,
                style: AlmaraiMedium.copyWith(color: Theme.of(context).colorScheme.primary, fontSize: Dimensions.fontSizeLarge),):const SizedBox(),
              Text(NumberFormat.compact().format(countNumber),
                  style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge,color: Theme.of(context).colorScheme.primary)),
            ])),
          Text(title!.tr,textAlign: TextAlign.center,style: AlmaraiRegular.copyWith(color: Theme.of(context).colorScheme.primary),),
      ],),),
    );
  }
}