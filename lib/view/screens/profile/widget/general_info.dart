            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text('first_name'.tr, style: AlmaraiRegular),
                  ...
                  Text('last_name'.tr, style: AlmaraiRegular),
                  ...
                  Row(
                    children: [
                      Text('email'.tr, style: AlmaraiRegular),
                      Padding(
                        padding:  EdgeInsets.only(left: Dimensions.paddingSizeExtraSmall),
                        child: Text('(${'not_editable'.tr})', style: AlmaraiRegular.copyWith(fontSize: Dimensions.paddingSizeSmall,
                  ...
                  Row(
                    children: [
                      Text('phone_no'.tr, style: AlmaraiRegular),
                      Padding(
                        padding:  EdgeInsets.only(left: Dimensions.paddingSizeExtraSmall),
                        child: Text('(${'not_editable'.tr})', style: AlmaraiRegular.copyWith(fontSize: Dimensions.paddingSizeSmall,
                            color: Theme.of(context).hintColor.withOpacity(.75))),
                  ...
                  Text('address_s'.tr, style: AlmaraiRegular),
                   SizedBox(height: Dimensions.paddingSizeSmall),
                  CustomTextField(
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(
                    children: [
                      Text('identity_number_and_card'.tr, style: AlmaraiRegular),
