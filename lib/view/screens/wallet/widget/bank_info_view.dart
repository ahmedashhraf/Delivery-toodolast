                ...
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                      Text('edit_info'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge,
  ...
  Widget build(BuildContext context) {
    return Padding(padding:  EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault, Dimensions.paddingSizeSmall, Dimensions.paddingSizeDefault, Dimensions.paddingSizeSmall),
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('${title!.tr} : ', style: AlmaraiRegular.copyWith(color:Get.isDarkMode? Theme.of(context).hintColor: Theme.of(context).cardColor)),
          SizedBox(width: Get.width/2.4, child: Text(value!, style: AlmaraiRegular.copyWith(color:Get.isDarkMode? Theme.of(context).hintColor: Theme.of(context).cardColor))),
