        ...
        builder: (profileController) {
          return Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
            Padding(
              ...
              child: Text('order_status'.tr,style:  AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge,
      ...
      child: Padding(
        ...
        child: Container(decoration: BoxDecoration(
          ...
          color: color!.withOpacity(.55)),
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
             Container(padding:  EdgeInsets.symmetric(horizontal : Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeSmall),
              ...
              child: SizedBox(width: 30,child: Image.asset(icon!)),
                ...
                Text(title!.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w400),),
               ],),),
              Padding(
            ...
            ),child: Text(NumberFormat.compact().format(totalCount),style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge),),),
          )
        ],)),
      ),
    );
