  ...
  Widget build(BuildContext context) {
    return Scaffold(
                ...
                Padding(padding:  EdgeInsets.only(top: Dimensions.paddingSizeSmall),
                  child: Container(decoration: BoxDecoration(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Expanded(child: Text('additional_delivery_charge_by_admin'.tr, style: AlmaraiMedium,)),
                      ...
                      DottedBorder(
                        ...
                        child: Container(
                          ...
                          child: Row( children: [
                            Text(PriceConverter.convertPrice(widget.orderModel!.deliveryManCharge),style: AlmaraiMedium),
                          ],),),),
      ...
      bottomNavigationBar: GetBuilder<OrderController>(
        builder: (orderController) {
          return SizedBox(height: (orderModel!.orderStatus == 'processing' || orderModel!.orderStatus == 'out_for_delivery') && orderModel!.isPause == '0'?80:0,
                  ...
                  Padding(padding: EdgeInsets.all(Dimensions.paddingSizeDefault),
                    ...
                    onTap: (){
                      if(orderController.identityImages.isNotEmpty){
                        ...
                        print("=======> otp===> ${Get.find<SplashController>().configModel?.orderVerification}");
                        if(Get.find<SplashController>().configModel?.orderVerification == 1){
                          showModalBottomSheet<void>(
                            backgroundColor: Colors.transparent,
                            isScrollControlled: true,
