              ...
              Padding(
                ...
                child: Container(padding:  EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                  ...
                  child: DropdownButton<String>(
                    ...
                    hint: orderController.reasonValue == ''? Text('select_reason'.tr, style: AlmaraiRegular,) : Text(orderController.reasonValue!.tr,
                      ...
                      return DropdownMenuItem<String>(
                        alignment: Alignment.center,
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(value.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
