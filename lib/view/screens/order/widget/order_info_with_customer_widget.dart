          ...
          return Container(
            ...
            child: Column(children: [
              Padding(
                ...
                child: Text('${'order'.tr} # ${orderModel!.id}',style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge,
              ...
              GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Container(decoration: BoxDecoration(
                      ...
                      child: Text('view_on_map'.tr,style: AlmaraiRegular.copyWith(color: Theme.of(context).colorScheme.secondary))),
                ),
              ),
