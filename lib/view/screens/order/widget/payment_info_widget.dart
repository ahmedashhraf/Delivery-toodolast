        ...
        child: Column(children: [
          Row(children: [
            ...
            Padding(padding:  EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: Dimensions.paddingSizeDefault),
              child: Text('payment_info'.tr,style: AlmaraiMedium.copyWith(color: Get.isDarkMode? Theme.of(context).hintColor.withOpacity(.5) : Theme.of(context).primaryColor,
         ...
         Padding(
           ...
           child: Column(children: [
             ...
             OrderItemInfoWidget(title: 'grand_total',textColor: Theme.of(context).primaryColor, info: totalPrice.toString(),isPrice: true,),
           ],),
         )
