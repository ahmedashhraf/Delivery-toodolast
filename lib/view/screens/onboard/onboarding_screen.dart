              ...
              Column(children: [
                  ...
                  itemBuilder: (context, index) {
                    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text(onBoardingController.onBoardingList[index].title,
                        style: AlmaraiRegular.copyWith(fontSize: Dimensions.paddingSizeDefault, color: Theme.of(context).primaryColor),
                ...
                GestureDetector(onTap: (){
                  ...
                  Get.offAll(const LoginScreen());
                    ...
                    child: Text('skip'.tr,style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor.withOpacity(.7)))):

                InkWell(onTap: () {
                  Get.find<SplashController>().disableIntro();
                  Get.offAll(const LoginScreen());},
                    child: Text('get_started'.tr,style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor))),
