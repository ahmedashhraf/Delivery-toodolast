              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: items[index] == type
                      ? AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white)
                      : AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor),
                ),
              ),
            ),
          );
