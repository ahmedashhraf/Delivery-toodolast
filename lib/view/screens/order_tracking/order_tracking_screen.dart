          ...
          builder: (riderController) {
            ...
            return ExpandableBottomSheet(
              ...
              persistentHeader:  Container(
                ...
                child: Text('${riderController.distance != null? riderController.distance!.toStringAsFixed(2) : 0} km', style: AlmaraiRegular.copyWith(color: Theme.of(context).cardColor)),
              ),
