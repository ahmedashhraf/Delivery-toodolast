      ...
      child: GetBuilder<OrderController>(builder: (order) {
        return Padding(
          ...
          child: Container(
            ...
            child: Text(text, style: order.orderTypeFilterIndex == index ? AlmaraiMedium.copyWith(color: order.orderTypeFilterIndex == index
                ? Colors.white : Theme.of(context).textTheme.bodyLarge as Color?):
            AlmaraiRegular.copyWith(color: order.orderTypeFilterIndex == index
