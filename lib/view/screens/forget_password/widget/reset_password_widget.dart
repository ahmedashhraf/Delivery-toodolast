              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Padding(
                    ...
                    child: Text('new_password'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault),),
                  ),
                  Container(
                      margin:
                  ...
                  Padding(
                    padding:  EdgeInsets.symmetric(vertical: Dimensions.paddingSizeDefault),
                    child: Text('confirm_password'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ),
                  Container(
