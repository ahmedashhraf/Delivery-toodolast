          ...
          return Column(mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('please_enter_4_digit_code'.tr,style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault),
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Text('resend'.tr,
                      style: AlmaraiMedium.copyWith(color:Get.isDarkMode? Theme.of(context).hintColor: Theme.of(context).primaryColor.withOpacity(.75)),)),
                ),
              ]),
