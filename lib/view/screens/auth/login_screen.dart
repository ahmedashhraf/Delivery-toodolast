              ...
              return ListView(
                ...
                children: [
                      ...
                      child: Column(
                        children: [
                          Row(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(AppConstants.appName, style: AlmaraiMedium.copyWith(
                                  fontSize: Dimensions.fontSizeLarge)),
                              Text(' APP', style: AlmaraiMedium.copyWith(
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text('${'welcome_to'.tr} ${AppConstants.companyName}', style: AlmaraiMedium.copyWith(
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                    Text('login'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge,
                        color:Get.isDarkMode? Theme.of(context).hintColor.withOpacity(.5) : Theme.of(context).primaryColor)),
                     SizedBox(height: Dimensions.fontSizeExtraSmall),
                    Text('to_reach_your_customer_destination'.tr,style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
                  ],),
                   SizedBox(height: Dimensions.topSpace),
                          ...
                          child: Row(children: [
                            SizedBox(width: Dimensions.loginColor,
                              child: CodePickerWidget(
                                ...
                                showFlagMain: true,
                                flagWidth: 25,
                                textStyle: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.displayLarge!.color),
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('terms_and_conditions'.tr,
                            style: AlmaraiRegular.copyWith(color:Get.isDarkMode? Theme.of(context).hintColor.withOpacity(.5) : Theme.of(context).primaryColor, decoration: TextDecoration.underline),),
                        ],
                      ),
                    ),
                  ),
